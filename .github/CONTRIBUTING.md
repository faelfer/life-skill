# Contributing to Life Skill Server
...
- [x] Open the [Life Skill Server GitHub page](https://github.com/faelfer/life-skill-server) and click the ★ Star and then ⑂ Fork buttons.
- [x] Run `npm il` to install all dependencies and `npm run dev` to run project.
...
- [x] Visit your fork on GitHub.com ([https://github.com/YOUR-USER-NAME/life-skill-server](https://github.com/YOUR-USER-NAME/life-skill-server)) and create a pull request for your changes.
...
* Push your changes to a topic branch in your fork of the repository. Your branch should be based on the `main` branch
...
Bugs are tracked as [GitHub issues](https://github.com/faelfer/life-skill-server/issues). If you found a bug with xplore, the quickest way to get help would be to look through existing open and closed [GitHub issues](https://github.com/faelfer/life-skill-server/issues/issues?q=is%3Aissue). If the issue is already being discussed and hasn't been resolved yet, you can join the discussion and provide details about the problem you are having. If this is a new bug, please open a [new issue](https://github.com/faelfer/life-skill-server/issues/new).
...
We track discussions of new features, proposed changes, and other ideas as [GitHub issues](https://github.com/faelfer/life-skill-server/issues). If you would like to discuss one of those, please first look through existing open and closed [GitHub issues](https://github.com/faelfer/life-skill-server/issues?q=is%3Aissue) and see if there is already a discussion on this topic which you can join. If there isn't, please open a [new issue](https://github.com/faelfer/life-skill-server/issues/new).
